...
/**
 * Note that x positions must begin with 0.5. Otherwise they are not displayed. 
 * @author asamsenesena
 *
 */
public class Tut11 {
    
    private static Scene _scene_7;
    
    public static void start(Director _director_7) throws Exception {
        
        if (_scene_7 == null) {
            
            _scene_7= _director_7.createScene();
